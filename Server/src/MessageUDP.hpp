...
{
public:
    AuthMessageUDP(std::vector<uint8_t> Bytes);
...
{
public:
    JoinMessageUDP(std::vector<uint8_t> Bytes);
...
{
public:
    TextMessageUDP(std::string Nickname, std::string MessageContent, uint16_t MessageID);
...
{
public:
    ErrorMessageUDP(std::string ErrorContent, std::string Nickname, uint16_t MessageID);
