...
{
public:
    AuthMessageTCP(std::vector<uint8_t> Bytes);
    ~AuthMessageTCP() {};
...
{
public:
    JoinMessageTCP(std::string Channel, std::string Nickname);
    JoinMessageTCP(std::vector<uint8_t> Bytes);
    ~JoinMessageTCP() {};
...
{
public:
    TextMessageTCP(std::string Nickname, std::string MessageContent);
...
{
public:
    ErrorMessageTCP(std::string ErrorContent, std::string Nickname);
